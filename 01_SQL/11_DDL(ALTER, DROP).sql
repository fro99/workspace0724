...
ALTER TANLE DEPT_COPY ADD CONSTRAINT DEPT_PK PRIMARY KEY(DEPT_ID);

--DEPT_TITLE에 UNOQUE제약조건 추가
...
--DROP TABLE 테이블명 CASCADE CONSRAINT 
...
ALTER TABLE DEPT_COPY RENAME TO DEPT_DD;
