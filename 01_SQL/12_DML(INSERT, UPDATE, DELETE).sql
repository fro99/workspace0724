/*
    ...
    TCL(TRANSACTION 트랜잭션 데어어) : COMMIT, ROLLBACK
...
/*
    ...
    컬럼값을 제시하지 않은 값은 기본적으로 NULL이 들어가며 DEFAULT가 설정되어 있다면 DEFAULT값으로 설정됨.
    ->DEFAULT값이 없고 NOT NULL 제약조건이 걸려있는 컬럼은 반드시 직접 값을 넣어줘야한다.
*/
...
-- EMP_SALARY 테이블에서 노용철 사원의 급여를 100만원으로 변경
UPDATE EMP_SALARY
SET SALARY = 1000000
WHERE EMP_NAME = '노용철';
