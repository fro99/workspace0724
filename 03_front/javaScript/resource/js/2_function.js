...
//일급객체, 1종객체/변수 -> 변수에 담을 수 있다. 함수의 인자로 전달이 가능, 함수의 결과로 반환할 수 있다.
...
let test4 = function(name){
    //js의 함수는 기본적으로 arguments객체를 가지고있음. -> 전달받은 인자값이 들어있는 배열
...
test4("최지원");
test4("최지원", 55);
test4("최지원",55,"경기도 광명시");

//아래코드는 지피타가 만들어줌 지금은 쓰지않는다. 리액트에서 쓴다.
let test5 = () => 200;
console.log(test5());